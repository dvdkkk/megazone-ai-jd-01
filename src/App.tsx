...
const coursesData: CourseTrack[] = [
  {
    ...
    detailUrl: 'https://megazone-ai-jd-01.vercel.app'
  },
  {
    id: 'architect',
    trackCode: 'TRACK 02',
    ...
    detailUrl: 'https://megazone-ai-jd-02.vercel.app'
  },
  {
    id: 'security',
    trackCode: 'TRACK 03',
    ...
    detailUrl: 'https://megazone-ai-jd-03.vercel.app'
  },
  {
    id: 'data',
    trackCode: 'TRACK 04',
    ...
    detailUrl: 'https://megazone-ai-jd-04.vercel.app'
  }
];
...
const regCourseSteps: CurriculumStep[] = [
  {
    ...
    items: [
      '생성형 AI 트렌드와 LLM 핵심 원리 이해',
      'AIR Studio 기반 AI 모델 실습',
      'AI 서비스 개발을 위한 필수 개념 학습'
    ]
  },
  {
    stepNum: 2,
    ...
    items: [
      'Zero-shot · Few-shot · CoT 프롬프팅',
      '고품질 AI 응답을 위한 프롬프트 설계',
      '멀티모달 AI 및 업무 자동화 활용'
    ]
  },
  {
    ...
    icon: <Laptop size={24} />,
    items: [
      'AI 기반 요구사항 분석과 화면 설계',
      '자연어 코드 생성 및 디버깅',
      'MVP를 빠르게 구현하는 바이브 코딩'
    ]
  },
  {
    stepNum: 4,
    title: 'FastAPI 백엔드 개발',
    icon: <Building2 size={24} />,
    items: [
      'Python · FastAPI 기반 API 서버 구축',
      'Pydantic · SQLAlchemy · DB 연동',
      'Docker 기반 AI 백엔드 개발 환경 구성'
    ]
  },
  {
    stepNum: 5,
    title: 'LangChain 애플리케이션',
    icon: <Layers size={24} />,
    items: [
      'LangChain 기반 LLM 애플리케이션 개발',
      'LCEL을 활용한 체인 및 프롬프트 구성',
      'Tool Calling과 Output Parser 활용'
    ]
  },
  {
    stepNum: 6,
    ...
    items: [
      '문서 수집 · 청킹 · 임베딩 파이프라인 구축',
      'Vector Database 기반 검색 시스템 개발',
      'Hybrid Search · Reranking으로 성능 향상'
    ]
  },
  {
    stepNum: 7,
    ...
    items: [
      ...
      'ReAct · 상태관리 · Workflow 설계',
      '멀티 에이전트 협업 시스템 구축'
    ]
  },
  {
    stepNum: 8,
    title: 'Cloud Native 배포',
    icon: <Cloud size={24} />,
    items: [
      'Docker · Kubernetes 기반 컨테이너 배포',
      'AWS 클라우드 AI 서비스 운영',
      'GitOps 및 확장형 서비스 아키텍처 구축'
    ]
  }
];
...
const projCourseSteps: CurriculumStep[] = [
  {
    stepNum: 9,
    title: 'Vibe Coding MVP 프로젝트',
    icon: <Target size={24} />,
    items: [
      'PRD 작성부터 UI · DB 연동까지 구현',
      'AI와 협업하여 MVP 서비스 개발',
      'Vercel 배포 및 프로젝트 시연'
    ]
  },
  {
    stepNum: 10,
    title: '기업형 AI Agent 플랫폼',
    icon: <Briefcase size={24} />,
    items: [
      'AI 자율형 업무 비서 개발',
      '고객 지원 티켓 자동화 시스템 구축',
      '채용 서류 검토 및 면접 지원 Agent 개발'
    ]
  },
  {
    stepNum: 11,
      ...
      <header className="header" id="header">
        <div className="header-inner">
          <div className="header-left">
            <a href="https://megazone-ai-jd.vercel.app" className="logo-wrap" id="headerLogoLink">
              <img
            ...
            <nav className="gnb-nav">
              <a href="https://megazone-ai-jd-01.vercel.app">AI 에이전트</a>
              <a href="https://megazone-ai-jd-02.vercel.app">AI 아키텍트</a>
              <a href="https://megazone-ai-jd-03.vercel.app">AI 보안</a>
              <a href="https://megazone-ai-jd-04.vercel.app">AI 데이터</a>
              <a href="#faq">FAQ</a>
            </nav>
          </div>
          <div className="header-right">
            <a
              href="https://naver.me/5Ea2LNnT"
              target="_blank"
        ...
        <div className={`mobile-drawer ${mobileMenuOpen ? 'open' : ''}`} id="mobileDrawer">
          <a href="https://megazone-ai-jd-01.vercel.app" onClick={() => setMobileMenuOpen(false)}>AI 에이전트</a>
          <a href="https://megazone-ai-jd-02.vercel.app" onClick={() => setMobileMenuOpen(false)}>AI 아키텍트</a>
          <a href="https://megazone-ai-jd-03.vercel.app" onClick={() => setMobileMenuOpen(false)}>AI 보안</a>
          <a href="https://megazone-ai-jd-04.vercel.app" onClick={() => setMobileMenuOpen(false)}>AI 데이터</a>
          ...
          <div className="hero-summary-box mb-8">
            <div className="summary-grid">
              ...
              <div className="summary-item">
                ...
                <strong className="sum-val">과천 캠퍼스 — 과천 메가존클라우드 2층 교육장</strong>
              </div>
              <div className="summary-item">
                <span className="sum-label">
          ...
          <div className="track-cards-grid" id="trackCardsGrid">
            <div className="ncloud-card card-cyan reveal-item reveal-delay-1">
              <div>
                ...
                <h3 className="card-title">AI 에이전트, 도입 원년</h3>
                <p className="card-text">
                  기업들이 챗봇을 넘어 업무를 스스로 수행하는 AI 에이전트를 도입하기 시작했습니다. 에이전트를 설계·구현할 수 있는 개발자는 아직 극소수입니다.
                </p>
              </div>
            </div>
            ...
            <div className="ncloud-card card-navy reveal-item reveal-delay-2">
              <div>
                ...
                <h3 className="card-title">LLM 애플리케이션 개발자 수요 급증</h3>
                <p className="card-text">
                  LLM API·RAG 활용 경험이 백엔드·서비스 개발 채용의 우대 조건으로 빠르게 자리 잡고 있습니다.
                </p>
              </div>
            ...
            <div className="ncloud-card card-purple reveal-item reveal-delay-3">
              <div>
                ...
                <h3 className="card-title">포트폴리오가 곧 실력</h3>
                <p className="card-text">
                  이 분야는 경력자도 드물어, 실제 동작하는 에이전트 포트폴리오만으로 신입이 승부할 수 있는 몇 안 되는 영역입니다.
                </p>
              </div>
      ...
      <section className="section-why-megazone" id="features" style={{ paddingTop: '80px', paddingBottom: '80px', borderTop: '1px solid #f1f5f9' }}>
        <div className="container">
          <div className="reveal-item" style={{ textAlign: 'center', marginBottom: '36px' }}>
            ...
            <p className="section-desc">개념을 넘어 실제 동작하는 AI 서비스 개발로 연결합니다.</p>
          </div>
          ...
          <div className="why-megazone-grid">
            <div className="why-megazone-card reveal-item reveal-delay-1">
              ...
              <div className="why-card-sub">서비스가 되는 AI</div>
              <p className="why-card-desc">
                LLM·RAG를 개념이 아닌 실제 동작하는 서비스 코드로 구현합니다.
              </p>
            </div>

            <div className="why-megazone-card reveal-item reveal-delay-2">
              <div className="why-card-title">02</div>
              <div className="why-card-sub">Vibe Coding 개발 방식</div>
              <p className="why-card-desc">
                AI와 협업하는 바이브 코딩으로 기획부터 MVP까지 개발 속도를 혁신합니다.
              </p>
            </div>

            <div className="why-megazone-card reveal-item reveal-delay-3">
              <div className="why-card-title">03</div>
              <div className="why-card-sub">에이전트 설계 심화</div>
              <p className="why-card-desc">
                LangChain·LangGraph 기반 상태 제어, ReAct, 멀티 에이전트 협업까지 다룹니다.
              </p>
            </div>

            <div className="why-megazone-card reveal-item reveal-delay-4">
              <div className="why-card-title">04</div>
              <div className="why-card-sub">기업형 프로젝트 포트폴리오</div>
              <p className="why-card-desc">
                업무 자동화 비서, 티켓 자동 응대 등 기업형 AI Agent 플랫폼을 직접 구축합니다.
              </p>
            </div>
          </div>
        </div>
